define(['application-configuration', 'ajaxServices'], function (app)
{
    app.register.service('bnkNotificationService', ['ajaxServices', function (ajaxServices)
    {
        ...
        this.getProcessedNotification = function (id, callbackFunction) {
            return ajaxServices.AjaxGet("/Notification/GetBankProcessedNotifications?id=" + id, callbackFunction);
        };
        
        this.getUnProcessedNotification = function (id, callbackFunction)
        {
            return ajaxServices.AjaxGet("/Notification/GetBankNotifications?id=" + id, callbackFunction);
        };
