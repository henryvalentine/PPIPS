define(['application-configuration', 'ajaxServices'], function (app) {
    app.register.service('calculatorService', ['ajaxServices', function (ajaxServices) {
        
        this.addCalculator = function (calculator, callbackFunction) {
            return ajaxServices.AjaxPost({ calculator: calculator }, "/Calculator/AddCalculator", callbackFunction);
        };
