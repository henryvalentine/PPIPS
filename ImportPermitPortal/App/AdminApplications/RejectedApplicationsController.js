...
{
    app.register.directive('ngRApps', function ($compile)
    {
        return function ($scope, ngRApps)
        {
            var tableOptions = {};
            tableOptions.sourceUrl = "/Application/GetRejectedApplications";
            ...
            var ttc = adminApplicationtableManager($scope, $compile, ngRApps, tableOptions);
