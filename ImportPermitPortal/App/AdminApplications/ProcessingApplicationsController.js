...
{
    app.register.directive('ngPrApps', function ($compile)
    {
        return function ($scope, ngPrApps)
        {
            var tableOptions = {};
            tableOptions.sourceUrl = "/Application/GetProcessingApplications";
            tableOptions.itemId = 'ApplicationId';
            tableOptions.columnHeaders = ['ReferenceCode', 'ImporterStr', 'DerivedQuantityStr', 'DerivedValue', 'DateAppliedStr', 'LastModifiedStr', 'StatusStr'];
            var ttc = adminApplicationtableManager($scope, $compile, ngPrApps, tableOptions);
