...
{
    app.register.directive('ngSApps', function ($compile)
    {
        return function ($scope, ngSApps)
        {
            var tableOptions = {};
            tableOptions.sourceUrl = "/Application/GetSubmittedApplications";
            ...
            var ttc = adminApplicationtableManager($scope, $compile, ngSApps, tableOptions);
