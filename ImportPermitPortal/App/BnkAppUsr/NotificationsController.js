   ...
   app.register.directive('ngBnkNtfs', function ($compile)
    ...
    function (ngDialog, $scope, $rootScope, $routeParams, bnkNotificationService, $location, $upload, $timeout, fileReader, $http)
    {
        ...
        $scope.getNotification = function (id)
        {
            ...
            $scope.referenceCode = id;
            $location.path('/BnkAppUsr/UploadNotificationDocs/' + $scope.referenceCode);
        };
        ...
        $scope.viewNotification = function (id)
        {
            ...
            $scope.referenceCode = id;
            bnkNotificationService.getProcessedNotification(id, $scope.getProcessedNotificationCompleted);
        };

        $scope.getProcessedNotificationCompleted = function (response)
        {
