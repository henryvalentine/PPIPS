...
function issueTableManager($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, deleteMethodRecordName, addBtnWidth) 
{
    var columnOptions = [{
        "sName": tableOptions.itemId,
        "bSearchable": false,
...
function employeeDeskTableManager($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, deleteMethodRecordName, addBtnWidth, changePassword) {
...
function appUsertableManager($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, addBtnWidth, changePassword) {
...
function RecertiyManager($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, addBtnWidth) {
...
function depotTableManager($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, addBtnWidth) {
...
function tableManagerNoDelete($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, deleteMethodRecordName, addBtnWidth) {
...
function productsTableManager($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, deleteMethodRecordName, addBtnWidth) {
...
function bankUserTableManager($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, addBtnWidth, changePassword) {
    ...
    var tth = '<div style="margin-top: 7.3%;"><a ng-click = "bulkUpload()" class="btn-default btn" style=" float: left;margin-left : 15%">Bulk Upload</a>&nbsp;&nbsp;&nbsp;<a ng-click = "' + prepareTemplateMethodName + '()" class="btnAdd btn" style="width: ' + addBtnWidth + 'px; float: right; text-align:right">' + newRecordButtomValue + '</a></div>';
    var kkh = $compile(tth)($scope);
    angular.element('#newItemLnk').append(kkh);
    $('.dataTables_filter input').addClass('form-control').attr('type', 'text').css({ 'width': '80%' });
    $('.dataTables_length select').addClass('form-control');
...
function bankBranchTableManager($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, addBtnWidth)
{
...
function bnkUserUnprocessedNotificationTableManager($scope, $compile, tableDirective, tableOptions)
{
    ...
    var jTable = tableDirective.dataTable({
        ...
        fnRowCallback: function (nRow, aData, iDisplayIndex)
        {
            ...
            {
                details = '<a title="Update Documents" style="cursor: pointer"><img src="/Images/updatedocs.png" id="' + aData[1] + '" ng-click="getNotificationByReference($event)"/></a> &nbsp;';
            } else
            {
                view = '<a title="Edit" style="cursor: pointer"><img src="/Images/view.png" id="' + aData[1] + '" ng-click="viewNotificationByReference($event)"/></a> &nbsp;';
            }
...
function bankTableManager($scope, $compile, tableDirective, tableOptions, newRecordButtomValue, prepareTemplateMethodName, retrieveRecordMethodName, manageUserMethod, addBtnWidth) {
