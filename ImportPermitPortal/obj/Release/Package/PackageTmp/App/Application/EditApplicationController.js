...
define(['application-configuration', 'applicationService','ngDialog', 'angularFileUpload', 'fileReader'], function (app) {
    ...
    app.register.controller('editapplicationController', [
        'ngDialog', '$scope', '$rootScope', '$routeParams', 'applicationService', '$location',
        function (ngDialog, $scope, $rootScope, $routeParams, applicationService, $location)
        {
            ...
            $scope.initializeController = function() {
                ...
                $rootScope.setPageTitle('Edit Application|DPR-PPIPS');
                $scope.edit = true;
            ...
            $scope.initializeApp = function() {
                ...
                $scope.application =
                {
                    ...
                    'ApplicationItemObjects': [],
                    'ApplicationType': { 'Id': '', 'Name': '--Select Application Type --' },
                    'ImportClass': { 'Id': '', 'Name': '--Select Import Category--' }
                };
            ...
            $scope.addApp = function() {
                ...
                else
                {
                    ...
                    angular.forEach($scope.appBankers, function(u, y) {
                        var banker = { 'Id': '', 'ApplicationItemId': '', 'BankId': u.BankId, 'DocumentId': '', 'BankName2': '' };
            ...
            $scope.setStageDocs = function() {
                ...
                var docStr = '<h4><b>Required Documents:</b></h4> <ul>';
