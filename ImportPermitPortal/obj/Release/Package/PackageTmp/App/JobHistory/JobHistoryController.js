...
define(['application-configuration', 'bnkAdminService', 'ngDialog', 'angularFileUpload', 'fileReader'], function (app)
{
    ...
    app.register.directive('ngHistory', function ($compile)
    {
        ...
        {
            var tableOptions = {};
            tableOptions.sourceUrl = "/Application/GetBankJobHistory";
            tableOptions.itemId = 'ApplicationId';
            tableOptions.columnHeaders = ['ReferenceCode', 'ImporterStr', 'DerivedTotalQUantity', 'DerivedValue', 'DateAppliedStr', 'StatusStr'];
   ...
   app.register.controller('jobHistoryController', ['ngDialog', '$scope', '$rootScope', '$routeParams', 'bnkAdminService', '$location',
    function (ngDialog, $scope, $rootScope, $routeParams, bnkAdminService, $location)
    {
        $rootScope.setPageTitle('Application Histories|DPR-PPIPS');
