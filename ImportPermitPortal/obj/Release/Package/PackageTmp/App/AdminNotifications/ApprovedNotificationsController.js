...
{
    app.register.directive('ngANtfs', function ($compile)
    {
        return function ($scope, ngANtfs)
        {
            var tableOptions = {};
            tableOptions.sourceUrl = "/Notification/GetApprovedNotifications";
            ...
            var ttc = adminNotificationTableManager($scope, $compile, ngANtfs, tableOptions);
    ...
    app.register.controller('approvedNotificationController', ['ngDialog', '$scope', '$rootScope', '$routeParams', 'userNotificationService', '$upload', 'fileReader', '$http', '$location', '$window',
    function (ngDialog, $scope, $rootScope, $routeParams, userNotificationService, $upload, fileReader, $http, $location,$window)
    {
        
        $scope.initializeApp = function ()
        {
            $rootScope.setPageTitle('Approved Notifications|DPR-PPIPS');
            $scope.viewApp = false;
            $scope.notification =
             {
                 'NotificationId': '',
