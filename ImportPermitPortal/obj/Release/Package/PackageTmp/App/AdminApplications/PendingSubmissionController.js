...
define(['application-configuration', 'adminApplicationService', 'ngDialog', 'angularFileUpload', 'fileReader'], function (app)
{
    app.register.directive('ngPApps', function ($compile)
    {
        ...
        {
            var tableOptions = {};
            tableOptions.sourceUrl = "/Application/GetApplicationsPendingSubmission";
            tableOptions.itemId = 'Id';
            tableOptions.columnHeaders = ['RRR', 'ImporterName', 'DerivedQuantityStr','TotalAmountPaidStr', 'DateAddedStr', 'StatusStr'];
            var ttc = adminApplicationtableManager($scope, $compile, ngPApps, tableOptions, 'getReceipt');
