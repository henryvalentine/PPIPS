...
define(['application-configuration', 'accountTypeService', 'ngDialog', 'angularFileUpload', 'fileReader'], function (app)
{
    app.register.directive('ngAccType', function ($compile)
    {
        ...
        {
            var tableOptions = {};
            tableOptions.sourceUrl = "/AccountType/GetAccountTypeObjects";
            tableOptions.itemId = 'AccountTypeId';
            tableOptions.columnHeaders = ['Name'];
            var ttc = tableManager($scope, $compile, ngAccType, tableOptions, 'Add Account Type', 'prepareAccTypeTemplate', 'getAccType', 'deleteAccType', 175);
    ...
    function (ngDialog, $scope, $rootScope, $routeParams, accountTypeService, $upload, fileReader, $location)
    {
        ...
        $scope.getAccType = function (impId)
        {
            ...
            accountTypeService.getAccountType(impId, $scope.getAccTypeCompleted);
        };
        ...
        $scope.initializeController = function ()
        {
            ...
            $scope.accountType =
           {
               'AccountTypeIdId': '', 'Name': '', 'Description' : ''
           };
